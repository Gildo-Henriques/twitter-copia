export default function Post(){
    const [texto, setTexto] = useState("")
      ...
      return (
        <div className="mt-20 h-auto border-bottom pt-5 w-full flex items-center justify-center flex-col">
          {/* TEXTAREA */}
          <div className="lg:w-[600px]  flex items-start space-x-3">
            <CosmosLogo />
            <div className="flex flex-col w-full pb-  ">
              ...
              <div className="flex justify-between 2xl:w-[600px] lg:w-[545px] px-2  items-center py-3 *:text-blue-500">
                ...
                <div className="flex items-center space-x-5">
                  ...
                  <button className="bg-white font-semibold px-5 py-2 rounded-full text-black">
                    Poste Público
                  </button>
                </div>
              </div>
